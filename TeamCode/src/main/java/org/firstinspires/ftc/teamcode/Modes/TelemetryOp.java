...
public class TelemetryOp extends OpMode {
	...
	public double claw_max_range		   = 0.25;
	public double claw_min_range		   = 0.00;
	...
	public void init() {
		...
		{   
			...
			motors.claw.setPosition(claw_min_range);
		}
		...
		// Handle gamepad2 inputs.
		{
			if (gamepad2.a) {
				if (is_buttonA_pressed == false) {
					...
					motors.claw.setPosition(is_claw_toggled ? claw_min_range : claw_max_range);
			...
			telemetry.addData("pressed A", is_claw_toggled);
		}
